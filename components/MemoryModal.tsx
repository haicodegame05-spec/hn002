...
export const MemoryModal: React.FC<Props> = ({ isOpen, onClose, settings, logs, turnCount }) => {
  ...
  const handleGenerateMemory = async () => {
    ...
    try {
      await memoryService.updateMemory(logs, turnCount, true);
      forceUpdate();
    } finally {
  ...
  if (settings.mobileMode) {
    return <MobileMemoryModal onClose={onClose} logs={logs} turnCount={turnCount} />;
  }
