...
2. MA TRẬN DỤC TÍNH & Ý CHÍ (LIBIDO & WILLPOWER):
   ...
   - Sau khi quan hệ (nếu không phải tự nguyện hoàn toàn), NPC sẽ rơi vào trạng thái "Hổ thẹn" hoặc "Uất hận", làm giảm mạnh Affinity thay vì tăng Libido ngay lập tức.
