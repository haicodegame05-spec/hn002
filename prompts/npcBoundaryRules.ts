...
1. MA TRẬN SO SÁNH NÂNG CAO (ADVANCED MATRIX):
   ...
   - PHÒNG NGỰ NPC (BASE DEFENSE) = [Alignment] + [Morality] + [Cảnh giới/Quyền lực] + [RELATIONSHIP SHIELD] + [WILLPOWER].

   * HỆ SỐ RELATIONSHIP SHIELD (LÁ CHẮN QUAN HỆ):
     - RUỘT THỊT (Mẹ, Chị, Em): +1000% Defense (Bất khả xâm phạm về mặt đạo đức).
     - HỌ HÀNG (Dì, Cô, Em họ): +500% Defense.
     - NGƯỜI LẠ/KẺ THÙ: 0% Defense.
   
   - HỆ SỐ BÀO MÒN (LUST EROSION) = [Affinity/2] + [Arousal Level (Mood)] + [Fetish Trigger].
   - LƯU Ý: Nếu MC hành động thô lỗ, cưỡng ép hoặc thiếu build-up tình cảm, Lust Erosion sẽ bị GIẢM 50% do NPC cảm thấy bị xúc phạm.

   => PHÒNG NGỰ THỰC TẾ (FINAL DEFENSE) = BASE DEFENSE - LUST EROSION.

2. QUY TẮC PHẢN KHÁNG CHO NGƯỜI THÂN (BLOOD RELATIVE LOGIC):
   - Người thân có ranh giới đạo đức cực kỳ kiên cố. Mọi ý nghĩ dâm dục với MC đều gây ra sự ghê tởm bản thân sâu sắc.
